...
class LocalizedString {
  ...
  final String? afar;
  final String? abkhazian;
  final String? avestan;
  final String? afrikaans;
  final String? akan;
  final String? amharic;
  final String? aragonese;
  final String? arabic;
  final String? assamese;
  final String? avaric;
  final String? aymara;
  final String? azerbaijani;
  final String? bashkir;
  final String? belarusian;
  final String? bulgarian;
  final String? biharilanguages;
  final String? bislama;
  final String? bambara;
  final String? bengali;
  final String? tibetan;
  final String? breton;
  final String? bosnian;
  final String? catalanValencian;
  final String? chechen;
  final String? chamorro;
  final String? corsican;
  final String? cree;
  final String? czech;
  final String? church;
  final String? chuvash;
  final String? welsh;
  final String? danish;
  final String? german;
  final String? divehiDhivehiMaldivian;
  final String? dzongkha;
  final String? ewe;
  final String? greekModern;
  final String? english;
  final String? esperanto;
  final String? spanish;
  final String? latinAmericanSpanish;
  ...
  final String? fijian;
  final String? faroese;
  final String? french;
  final String? westernFrisian;
  final String? irish;
  final String? gaelicScomttishGaelic;
  ...
  final String? hebrew;
  final String? hindi;
  final String? hiriMotu;
  final String? croatian;
  final String? haitianHaitianCreole;
  final String? hungarian;
  final String? armenian;
  final String? herero;
  final String? interlingua;
  final String? indonesian;
  final String? interlingueOccidental;
  final String? igbo;
  final String? sichuanYiNuosu;
  final String? inupiaq;
  final String? ido;
  final String? icelandic;
  final String? italian;
  final String? inuktitut;
  final String? japanese;
  final String? romanizedJapanese;
  final String? javanese;
  final String? georgian;
  final String? kongo;
  final String? kikuyuGikuyu;
  final String? kuanyamaKwanyama;
  final String? kazakh;
  final String? kalaallisutGreenlandic;
  final String? centralKhmer;
  final String? kannada;
  final String? korean;
  final String? romanizedKorean;
  final String? kanuri;
  final String? kashmiri;
  final String? kurdish;
  final String? komi;
  final String? cornish;
  final String? kirghizKyrgyz;
  final String? latin;
  final String? luxembourgishLetzeburgesch;
  final String? ganda;
  final String? limburganLimburgerLimburgish;
  final String? lingala;
  final String? lao;
  final String? lithuanian;
  final String? lubaKatanga;
  ...
  final String? nauru;
  final String? bokmalNorwegianNorwegianBokmal;
  final String? ndebeleNorthNorthNdebele;
  final String? nepali;
  final String? ndonga;
  final String? dutchFlemish;
  final String? norwegianNynorskNynorskNorwegian;
  final String? norwegian;
  final String? ndebeleSouthSouthNdebele;
  final String? navajoNavaho;
  final String? chichewaChewaNyanja;
  final String? occitan;
  final String? ojibwa;
  final String? oromo;
  final String? oriya;
  final String? ossetianOssetic;
  final String? panjabiPunjabi;
  final String? pali;
  final String? polish;
  final String? pushtoPashto;
  final String? portuguese;
  final String? brazilianPortugese;
  final String? quechua;
  final String? romansh;
  final String? rundi;
  final String? romanianMoldavianMoldovan;
  final String? russian;
  final String? kinyarwanda;
  final String? sanskrit;
  final String? sardinian;
  final String? sindhi;
  final String? northernSami;
  final String? sango;
  final String? sinhalaSinhalese;
  final String? slovak;
  ...
  final String? tatar;
  final String? twi;
  final String? tahitian;
  final String? uighurUyghur;
  final String? ukrainian;
  final String? urdu;
  final String? uzbek;
  final String? venda;
  final String? vietnamese;
  final String? volapuk;
  final String? walloon;
  final String? wolof;
  final String? xhosa;
  final String? yiddish;
  final String? yoruba;
  final String? zhuangChuang;
  final String? simplifiedChinese;
  final String? traditionalChinese;
  final String? romanizedChinese;
  final String? zulu;
